...
int find_key(struct BTreeNode *x, char *pszName);
void remove_key_from_leaf(struct BTreeNode *x, int k);
void delete_key_recursive(struct BTreeNode *x, char *pszName);
void delete_key_non_leaf(struct BTreeNode *x, int idx);
void fill(struct BTreeNode *x, int idx);
void borrow_from_prev(struct BTreeNode *x, int idx);
void borrow_from_next(struct BTreeNode *x, int idx);
